...
A sentence can be defined as a list of words (words being `Strings`). The string representation of a sentence is the concatenation of all of the words in the list, separated by a space.
